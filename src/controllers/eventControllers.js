...
router.get('/events/:id', async (req, res) => {
    if (!req.params.id)
        res.status(400).send('Event id was no provided');
...
router.put('/events/markdone/:id', verify, async (req, res) => {
...
router.put('/events/updatebanner/:id', verify, async (req, res) => {
    ...
    if (!isImage) res.status(400).send('Uploaded file must be an image with a png or jpeg extension');
